...
public class Annotator {
    ...
    public ArrayList project(String englishSentence, String sinhalaSentence) {



        logger.info("Projector is starting...");
        ...
        String sinhalaSentenceTok = tokenizer.tokenize(sinhalaSentence);
...
//                String sourceSentence = enReader.nextLine();
        ...
        Sentence parsedSL = slPipeline.parse(removePunctuations(englishSentence).trim());
        Sentence parsedTL = tlPipeline.parse(removePunctuations(sinhalaSentenceTok).trim());
...
//        }
     ...
     */
    private static ArrayList alignAndProject(Sentence parsedSL, Sentence parsedTL, Language targetLanguage) {
